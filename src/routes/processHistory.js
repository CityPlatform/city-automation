...
// Processes one batch of unread emails (up to BATCH_LIMIT) per call.
// Kept single-batch: looping multiple batches in one invocation hits
// Cloudflare's free-tier 50-subrequest-per-invocation limit. Call repeatedly
// until remaining is 0. Upgrading to Workers Paid (1000 subrequest limit)
// would allow re-enabling multi-batch looping if fewer manual calls are wanted.
